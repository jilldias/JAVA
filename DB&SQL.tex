...
\begin{itemize}
    \item Sempre usar WHERE em UPDATE e DELETE.
    \item Utilizar PRIMARY KEY.
    \item Criar índices em colunas muito pesquisadas.
    \item Nomear tabelas claramente.
    \item Evitar SELECT * em sistemas grandes.
    \item Fazer backup regularmente.
\end{itemize}
